    ...
    if obj_.type=="CAMERA":
        match status:
            ...
            case "line":
                ...
                x=math.sin(angle+pi/4)*math.sin(angle+pi/4)*math.sin(angle+pi/4)*math.sin(angle+pi/4)*Rx+x_center
                y=ratio*Ry-1
                z=1
                ...
                slide=0.2
                tar_y=-slide+slide*2*math.sin(ratio*pi*2)
                tar_x=-slide+slide*math.cos(ratio*pi*8)
                tar_z=-slide+slide*math.sin(ratio*pi*8)
                target=(tar_x,tar_y,0.5+tar_z)
                point_at(obj_, target, roll)
