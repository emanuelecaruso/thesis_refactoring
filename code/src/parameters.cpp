...
//
//
// float huber_threshold=(intensity_coeff_ba*gradient_coeff)*0.05;
// // float sat_threshold=0.04;
// float sat_threshold=(intensity_coeff_ba*gradient_coeff)*111111;
// float chi_occlusion_threshold=(intensity_coeff_ba*gradient_coeff)*0.1;
// // float total_error_thresh = 0.015;
// float total_error_thresh = (intensity_coeff_ba*gradient_coeff)*1111;
// // float occlusion_valid_ratio_thresh= 0.5;
// float occlusion_valid_ratio_thresh= 1;
// float valid_ratio_thresh= 0.2;
//
