...
float conv_threshold= (intensity_coeff_ba+gradient_coeff_ba)*0.001;
float level_error_multiplier_conv= 2;
...
float intensity_coeff_mapping= 0.1;
float gradient_coeff_mapping= 0.9;
