...
void CamerasContainer::deleteObj(){

  for(CameraForMapping* cam : frames_){
    if(cam)
      delete cam;
  }
  // for(CameraForMapping* cam : keyframes_active_){
  //   if(cam)
  //     delete cam;
  // }
  // for(CameraForMapping* cam : keyframes_to_marginalize_){
  //   if(cam)
  //     delete cam;
  // }
  // for(CameraForMapping* cam : keyframes_marginalized_){
  //   if(cam)
  //     delete cam;
  // }
  // for(CameraForMapping* cam : frames_with_active_pts_){
  //   if(cam)
  //     delete cam;
  // }
}
